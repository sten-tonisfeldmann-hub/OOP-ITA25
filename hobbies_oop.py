...
def sort_by_most_hobbies(people_list: list) -> list:
    ...
    """
    hobbies_amount = sorted(people_list, key=lambda person: (-len(person.hobbies), person.full_name))
    return hobbies_amount
...
def sort_people_and_hobbies(people_list: list) -> list:
    ...
    :return: sorted list of people.
    """
    hobbies_and_people_amount = sorted(people_list, key=lambda person: ((person.hobbies).sort(), person.full_name))
    return hobbies_and_people_amount
